# Vending Machine Application AS .Net Core Console Application

## Assignment

Your assignment for this week is to make a vending machine. 
It should be able to take requests from the user as to what product it is supposed to return. 
It should also take payment and send the product back to the user with an appropriate amount of change.

## Requirments

### Features: 

- Money should be input in fixed denominations: 1kr, 2kr, 5kr, 10kr, 20kr, 50kr, 100kr, 200kr, 500kr and 1000kr.
